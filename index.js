...
window.addEventListener("load", function () {
      ...
      navigator.webkitPersistentStorage.queryUsageAndQuota(function (
        ...
        navigator.webkitPersistentStorage.requestQuota(
          ...
          function (newQuota) {
            displayOutcome(
              "quota-management",
              newQuota == quota ? "success" : "default"
            )(newQuota);
          },
  ...
  const deviceOrientation = document.getElementById("do");

  deviceOrientation.addEventListener("click", (event) => {
    console.log(event);
    if (event.beta) {
      alert("your browser suports divice orientation");
      deviceOrientation.style.backgroundColor = "lightgreen";
    } else {
      alert("your browser doesnt suports divice orientation");
      deviceOrientation.style.backgroundColor = "red";
    }
  });
});
